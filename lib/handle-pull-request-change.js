...
async function handlePullRequestChange(context) {
	...
	const breakingHasSemi = body.indexOf('BREAKING CHANGE') > -1 ? body.indexOf('BREAKING CHANGE:') > -1 : true;
	const isSemantic = hasSemanticTitle && hasSemanticCommits && breakingHasSemi;
